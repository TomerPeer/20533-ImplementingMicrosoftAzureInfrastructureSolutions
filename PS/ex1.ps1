...
# Variables
$rg1Name 	= 'tomertestRG' # test resource group created in Exercise 2
$rg2Name 	= 'tomertestRG2' # resource group name to which you will move the resource
$resName	= 'tomertest-rt' # test resource created in Exercise 2
